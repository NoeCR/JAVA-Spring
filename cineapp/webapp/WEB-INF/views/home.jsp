        ...
        <div class="row">
			...
			<c:forEach items="${peliculas}" var="p">
	          <div class="col-xs-12 col-sm-6 col-md-3">
	            <img class="img-rounded" src="${urlPublic}/images/${p.imagen}" alt="Generic placeholder image" width="150" height="200">
	            <h4>${p.titulo}</h4>
	            <h4>
	              <span class="label label-default">${p.clasificacion}</span>
	              <span class="label label-default">${p.duracion} min</span>
	              <span class="label label-default">${p.genero}</span>
	            </h4>  
	            <%-- 
