...
<html lang="en">
	...
	<body>
     ...
     <jsp:include page="../includes/menu.jsp"></jsp:include>
		...
		<form:form action="${urlForm}" method="post" modelAttribute="horarios">
				<div class="row">         
					<div class="col-sm-3">
						<div class="form-group">
							<label for="idPelicula" class="control-label">Pelicula</label>  
							<!-- /////// Se genera automaticamente un select dinamico con las peliculas obtenidas de la clase de servicio del modelo Pelicula -->            
